...
export const bookPages: BookPage[] = [
  {
    ...
    body: "One performance. Many questions. An evidence-led journey through movement, music, material, story, and place.\n\nArnav Ajana",
    modelUrl: null,
    modelScale: 1,
  },
  {
