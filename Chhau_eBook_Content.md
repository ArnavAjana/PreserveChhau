...
Editorial centre: Mayurbhanj Chhau, understood alongside the two related Chhau traditions
Status: working manuscript developed through an AI-assisted process under Arnav’s direction. Final authorial review, practitioner consultation, permissions, model approval, and pediatric movement and safety review are still required.
Movement-guidance status: unvalidated draft. A pediatric movement and safety professional has not reviewed the activities for ages 8 to 14 or the Chhau-specific safety boundaries. A Chhau practitioner has not validated them. They are not medical advice or a safety certification.
...
<!-- BOOK_PAGE {"id":"how-to-use-this-book","pageType":"content","title":"How to Use This Interactive eBook","interactive":"sandbox-guide"} -->
...
<!-- BOOK_PAGE {"id":"promise-to-the-reader","pageType":"content","title":"My Promise to You"} -->
...
<!-- BOOK_PAGE {"id":"direction-becomes-expression","pageType":"content","title":"Direction Becomes Expression","plannedModels":["mayurbhanj-core.glb","seraikella-expression.glb","purulia-masked-core.glb"]} -->
A dancer stands still with a calm face. Direction, weight, and timing still communicate courage, doubt, or attention.
...
<!-- BOOK_PAGE {"id":"body-lab-boundary","pageType":"content","title":"A Body Lab With Clear Limits"} -->
...
Chhau has close ties with Chaitra Parva, a spring festival cycle held near the end of Chaitra, usually in April. One part of the year closes and another begins. Across the Chhau region, performance, worship, preparation, music, and community gathering meet during this period. [1][2]
...
<!-- BOOK_PAGE {"id":"three-levels-of-learning","pageType":"content","title":"Look Closely, Try Draft Activities With an Adult, Learn With a Practitioner"} -->
Every physical page in this eBook sits at one of three levels.
...
Royal patronage helped organise, fund, and publicise Mayurbhanj Chhau. The system did not last forever. When the former Mayurbhanj state merged with Odisha in 1949, the dance entered a difficult period. The court no longer supported training and performance in the same way. [3]
...
Chadchadi / Kadka / Charchari: Names for smaller, sharper percussion voices in different Chhau documentation. Label each instrument and spelling by region and musician.
